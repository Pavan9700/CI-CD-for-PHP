...
RUN sudo apt-get update -y && apt-get install php7.2 -y
RUN sudo apt-get install php7.2-cli -y && apt-get install php7.2-common -y
RUN sudo apt-get install php7.2-curl php7.2-gd php7.2-json php7.2-mbstring php7.2-intl php7.2-mysql php7.2-xml php7.2-zip -y
